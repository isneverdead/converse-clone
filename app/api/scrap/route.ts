...
export async function GET(request: any) {
    ...
    const response = await fetch(`https://www.converse.com/shop/womens-shoes?srule=Featured&start=35&sz=60`)
    ...
    return NextResponse.json({ products: cleanedShoeTitle, length: cleanedShoeTitle.length })
}
